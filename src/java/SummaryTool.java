...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
	void init(String newsTitle) throws IOException{
            ...
            String inputtxtfilePath = "D:\\Abdonasef Work 2\\FCI-CU\\Java projects\\News Summerizer\\scrabedNews\\";
            String outputtxtfilePath = "D:\\Abdonasef Work 2\\FCI-CU\\Java projects\\News Summerizer\\Summery\\";
            
            try {
                instream = new FileInputStream(inputtxtfilePath + newsTitle);
                isr = new InputStreamReader(instream, "UTF-8");
                
                outstream = new FileOutputStream(outputtxtfilePath + newsTitle, true);
...
//                System.out.println(sentence.value);
                try {    
                    osw.write(sentence.value);
                    
                } catch (IOException ex) {
                    Logger.getLogger(SummaryTool.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
	}
///////////////////////////////////////////////////////////////////////////////////////////////////////////
